 ...
 */
public class ElasticSearchEventClientFactory {
	 ...
	 */
	public EventElasticSearchClient getClient(ElasticSearch elasticSearch,String clientType, String[] hostNames, String elasticUser, String elasticPassword,
		...
		if (clientType.equalsIgnoreCase(TransportClient)) {
			...
			return new ElasticSearchRestEventClient(elasticSearch,hostNames, elasticUser, elasticPassword, serializer, extendElasticsearchPropes);
		}
