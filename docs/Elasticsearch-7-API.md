...
# Elasticsearch 7.0.9新特性

Elasticsearch 7.0.9与之前版本的差别，衔接ES 6和ES 8的中间版本，ES 7默认关闭indexType的支持，这样索引Index将不允许定义和使用indexType，ES 8完全去掉indexType的支持。
