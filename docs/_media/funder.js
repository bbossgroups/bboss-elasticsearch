(function() {
  function embed () {
    ...
    try {
      ...
      targetElement.innerHTML = '<div id="cf" style="max-width: 330px; margin: 0 auto;"> <div class="cf-wrapper" style="display: block; overflow: hidden; font-size: 14px; line-height: 1.4; font-family: Helvetica; padding: 15px;" align="left"> <div class="clearfix" style="overflow: auto;"> <a data-href="campaign_url" class="cf-img-wrapper" target="_blank" rel="noopener" style="float: left; margin-right: 15px;"> <img class="cf-img" src="images/logo2.png" style="vertical-align: middle; max-width: 130px; border: none;"> </a> <a data-href="campaign_url" class="cf-text" target="_blank" rel="noopener" style="color: #333; text-decoration: none;"> <strong>基于Elasticsearch Bboss</strong>, <span>快速构建高效、可靠、安全的Elasticserach全文检索以及统计分析应用</span> </a> </div> </div> </div> <style>#cf .clearfix::after { content: ""; clear: both; display: table; } </style>';
