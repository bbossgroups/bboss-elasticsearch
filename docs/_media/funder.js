(function() {
  function embed () {
    ...
    try {
      ...
      targetElement.innerHTML = '<div id="cf" style="max-width: 330px; margin: 0 auto;"> <div class="cf-wrapper" style="display: block; overflow: hidden; font-size: 14px; line-height: 1.4; font-family: Helvetica; padding: 15px;" align="left"> <div class="clearfix" style="overflow: auto;"> <a data-href="campaign_url" class="cf-img-wrapper" target="_blank" rel="noopener" style="float: left; margin-right: 15px;"> <img class="cf-img" src="images/logo2.png" style="vertical-align: middle; max-width: 130px; border: none;"> </a> <a data-href="campaign_url" class="cf-text" target="_blank" rel="noopener" style="color: #333; text-decoration: none;"> <strong>Elasticsearch Bboss</strong> <span>makes powerful, feature-rich JS data grids easy to build, with minimal setup</span> </a> </div> <a href="https://www.bbossgroups.com" data-target="powered_by_url" class="cf-powered-by" target="_blank" rel="noopener" style="margin-top: 8px; background-color: hsla(0, 0%, 0%, 0.05); text-align: center; display: block; font-size: 9px; font-weight: 400; letter-spacing: 0.5px; line-height: 2.2; text-transform: uppercase; color: hsla(0, 0%, 0%, 0.8); text-decoration: none; padding: 10px auto;"> <em>BBoss</em> ad by BBossgroup   </a> </div> </div> <style>#cf .clearfix::after { content: ""; clear: both; display: table; } </style>';
